defmodule Calendar.TimeZoneData do
  ...
  ## Example:
      ...
      [%DateTime{zone_abbr: "UTC", day: 31, hour: 23, minute: 59, month: 12, second: 60, std_offset: 0, time_zone: "Etc/UTC", micro_second: 0, utc_offset: 0, year: 1971},
       %DateTime{zone_abbr: "UTC", day: 30, hour: 23, minute: 59, month: 6, second: 60, std_offset: 0, time_zone: "Etc/UTC", micro_second: 0, utc_offset: 0, year: 1972},
       %DateTime{zone_abbr: "UTC", day: 31, hour: 23, minute: 59, month: 12, second: 60, std_offset: 0, time_zone: "Etc/UTC", micro_second: 0, utc_offset: 0, year: 1972}]
  """
  def leap_seconds do
    TZSource.leap_seconds
    |> Enum.map(fn(dt) ->
      {{year, month, day}, {hour, minute, second}} = dt
      %DateTime{zone_abbr: "UTC", micro_second: 0, time_zone: "Etc/UTC", utc_offset: 0,
